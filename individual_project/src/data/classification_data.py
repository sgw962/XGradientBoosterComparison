...
class CreateClassificationData:
    ...
    def normalise_data(self):
        if self.merged_df is None:
            ...
            numeric_cols.remove('Next Day Price Change', 'Net', '%Chg')
            scaler = MinMaxScaler()
    ...
    def return_data(self):
        ...
        self.normalise_data()
        self.merged_df.to_excel(f'/Users/seanwhite/OneDrive - University of Greenwich/Documents/Individual Project/Individual_Project_Code/data/{self.df_name} Classification Data.xlsx', index=False)
        return self.merged_df
    ...
    def visualise_price(self):
        ...
        """
        price = self.merged_df['Next Day Price Change']
...
data = pd.read_excel(f'/Users/seanwhite/OneDrive - University of Greenwich/Documents/Group Project/group_project_code/data/price history/Ocado Price History.xlsx')
create_data = CreateClassificationData(data, 'Ocado', ['covid', 'quarantine', 'lockdown'], '2019-03-31 2024-03-27', 'GB')
