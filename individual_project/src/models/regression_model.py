...
class RegressionModel:
    ...
    def get_metrics_dataframe(self):
        ...
        metrics_table.to_excel(f'/Users/seanwhite/OneDrive - University of Greenwich/Documents/Individual Project/Individual_Project_Code/individual_project/data/Metrics for {self.df_name} using {self.booster} booster.xlsx')
        return metrics_table


data = pd.read_excel('/Users/seanwhite/OneDrive - University of Greenwich/Documents/Individual Project/Individual_Project_Code/individual_project/data/stocks & trends/Ocado Stock & trends.xlsx')
create_model = RegressionModel(data, 'Ocado', 'gblinear')
